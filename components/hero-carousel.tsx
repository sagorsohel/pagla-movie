...
export function HeroCarousel({
  ...
  // Setup auto-rotate interval (15 seconds per slide)
  const resetTimer = () => {
    if (timerRef.current) {
  ...
  return (
    <div className="relative w-full h-[75vh] md:h-[88vh] bg-black overflow-hidden group/carousel">
      ...
      {/* Slide Content with sliding Framer Motion animations */}
      <div className="absolute inset-0 flex items-end z-15 pointer-events-none">
        <AnimatePresence custom={direction} mode="wait">
          <motion.div
            ...
            animate="animate"
            exit="exit"
            className="w-full max-w-2xl px-4 md:px-12 pb-16 md:pb-24 space-y-4 pointer-events-auto"
          >
